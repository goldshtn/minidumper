...
namespace Microsoft.Diagnostics.Runtime
{
    public unsafe class DbgEngDataReader : IDisposable, IDataReader
    {
        ...
        public bool IsMinidump
        {
            get
            {
                ...
                if (qual == DEBUG_CLASS_QUALIFIER.USER_WINDOWS_SMALL_DUMP)
                {
                    ...
                    m_minidump = (flags & DEBUG_FORMAT.USER_SMALL_FULL_MEMORY) == 0;
                    return (bool)m_minidump;
                }
        ...
        private void CreateClient(IDebugClient5 client)
        {
            ...
            m_spacesPtr = (IDebugDataSpacesPtr)m_client;
        ...
        public bool ReadMemory(ulong address, IntPtr buffer, int bytesRequested, out int bytesRead)
        {
            ...
            uint read;
            bool res = m_spacesPtr.ReadVirtual(address, buffer, (uint)bytesRequested, out read) >= 0;
